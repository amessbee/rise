---
layout: home
title: RISE — Research Internship Programme
---

## Welcome

RISE is a four-week mathematics research programme for A-level students. The programme covers graph theory, network controllability, combinatorial sequences, and discrete geometry — topics drawn from active mathematical research that are accessible with only A-level background.
...
| Demo | Description |
|------|-------------|
| [Zero Forcing Game](interactive/zero_forcing_game.html) | Click vertices to colour them blue, then simulate the zero forcing rule on various graphs |
| [PMI Grid Explorer](interactive/pmi_grid.html) | Explore zero forcing propagation on grid graphs and visualise the 2D sequence structure |
| [Centerpoint Visualiser](interactive/centerpoint.html) | Click to place points, then find the coordinatewise median, true centerpoint, and Tukey depth |
...
By the end of the programme, students will be able to state and discuss these open problems:
...
- **Colourful Centerpoint:** If n points are coloured with k colours (n/k of each), must there be a rainbow centerpoint?
...
*Programme hosted by [Lab Name], [University]. Student coordinators: Danish, Uzayr, Nimra, Ahsan, Maaz, Basit.*
