...
*There are no right or wrong answers. This helps us understand where you are starting from so we can make this week as useful as possible for you.*

---

## Part 1 — Mathematics Background

**Q1. Which of the following topics have you studied? (Circle all that apply)**

Algebra | Calculus | Statistics | Probability | Trigonometry | Vectors | Matrices | Complex Numbers | Proof by Induction | Proof by Contradiction | Graph Theory | Combinatorics | Number Theory | Geometry

**Q2. How would you rate your comfort with the following?** (1 = never seen it, 5 = very confident)

| Topic | Rating (1–5) |
|-------|-------------|
| Solving algebraic equations | |
| Writing a mathematical proof | |
| Understanding a proof written by someone else | |
| Counting arguments (combinatorics) | |
| Thinking about infinite processes or limits | |

**Q3. Have you encountered any of the following? (Circle if yes)**
...
**Q4. Describe a mathematical result, puzzle, or idea that you found genuinely surprising or beautiful (can be simple too don't worry):**
...
## Part 2 — Programming and Computing

**Q1. Do you have any programming experience?**  
☐ None  ☐ A little (school projects / tutorials)  ☐ Moderate (personal projects)  ☐ Confident

**Q2. If yes, which languages?**
...
**Q1. Which of the following best describes the kind of mathematics you enjoy most?** (Rank 1–4, with 1 being your favorite)

___ Puzzles and games (finding clever tricks)  
___ Applications (solving real-world problems)  
___ Proofs and theory (understanding *why* things are true)  
___ Computation (writing algorithms, exploring with code)

**Q2. What draws you to mathematics or science as a subject?**

&nbsp;

&nbsp;

**Q3. Is there a specific research area or career path you are curious about?**

&nbsp;

&nbsp;

**Q4. What do you hope to get out of this internship?**

&nbsp;

&nbsp;

**Q5. Is there anything you are nervous or uncertain about coming into this internship?**
...
## Part 5 — Algorithms and Computing
...
**Q2.** Here is a procedure described in plain English. No programming knowledge is needed — just follow the steps carefully. _(You can try this interactively at [🎮 Sequences Demo](../interactive/sequences.html).)_
...
&nbsp;
**Q2.**  Suppose you spend two hours trying to prove something and fail completely. What do you do next?
...
**Q5.** Is there an open mathematical or computational question — something no one knows the answer to — that you find genuinely interesting? It does not have to be famous. Describe it.
...
**Q2.** Where do you feel least prepared coming into this program? Be specific.
...
**Q3.** By the end of this program, what would make you feel the four weeks were well spent?
